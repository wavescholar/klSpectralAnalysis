...
cd('K:\AnalysisResults_070413\Tiles_Panel2_100HIGH_100LOW\V3_0_1_Panel2\');
metadataFile ='Panel2_100HIGH_100LOW__LargeBlobs.csv'

%cd('K:\AnalysisResults_070413\Tiles_Panel3\V3_0_1_Panel3\');
%metadataFile ='Panel3_MedsizedBlobs_HIGH_INT_LOW.csv'

% cd('K:\AnalysisResults_070413\Tiles_Panel5\V3_0_1_Panel5');
% metadataFile ='Panel5_Redacted_1LgPerCase_320_BlobMetadata.csv'
...
for i = 2:3:30
    ...
    figure; hold on;
    rsH =randsample(size(E1to3_High,1),1600);
    rsI =randsample(size(E1to3_Int,1),1600);
    rsL =randsample(size(E1to3_Low,1),1600);
    ...
    title( ['EV ',num2str(i),' ' ,num2str(i+1),' ',num2str(i+2)])
end
