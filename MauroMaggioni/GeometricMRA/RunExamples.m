...
%% Pick a data set
pExampleNames  = {'MNIST_Digits','YaleB_Faces','croppedYaleB_Faces','NaturalImagePatches','ScienceNews', 'IntegralOperator','MeyerStaircase', ...
                           'SwissRoll','S-Manifold','Oscillating2DWave','D-Ball','D-Sphere', 'D-Cube','D-FlatTorus','Cosine','Signal1D_1','D-Gaussian'};
