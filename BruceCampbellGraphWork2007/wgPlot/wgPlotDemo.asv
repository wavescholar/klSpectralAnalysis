...
A(find(A))=(rand(size(find(A)))+0.01)*10;  % make non-zero element of A random.
figure;
tic;
...
%% It is pretty fast for large graphs too. You can also specify the colormap for the edges.
