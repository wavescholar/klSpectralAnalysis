...
XY_fr=fruchterman_reingold_force_directed_layout(sparse(Afmmc*1.0),'initial_temp',150);
wgPlot(Afmmc,XY_fr,'vertexWeight',V(:,3),'edgecolormap',pink);
title('Edge weighing represents fastest mixing Markov Chain. \newline Node weights are components of the third eigenvector of the graph laplacian.');
